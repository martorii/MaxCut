...
Original file is located at
    https://colab.research.google.com/drive/1jDOSV3jShOyhISEhdblh4hanY8w7FUin
"""
...
def PlotGraph(W, partition = None):
    ...
    if partition is not None:
        ...
        nx.circular_layout(G, pos, with_labels=True, edgelist=edges, edge_color=weights, width=5.0, edge_cmap=plt.cm.Blues)
