...
nodes, smoothed_complexities = RandomGridSmoothedComplexityHeuristic(min_nodes, max_nodes, num_nodes, initial_partition_type, k, dropout, 
                                  min_weight, max_weight, iters_for_nk, iters_for_w, heuristics, 
                                  sigma, plotMaxEvolution = False, plotWorstGraph = False, storeCSV=True)
